...
for(const file of ['prototype.html','references.html','index.html','garage.html','style.css','cinematic.css','PROTOTYPE.md'])fs.copyFileSync(path.join(root,file),path.join(out,file));
