...
| 6 | « Première période », driven | Bot drove it in **99.4 s of the 130 s** timer, +$20. `tools/timers.md` puts the leg at 1 925 m — a 53 km/h door-to-door average in a 131 km/h truck. Fair, but it is the first thing a new player ever does and there is no margin for one wrong turn. | annoying | open |
