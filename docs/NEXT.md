...
- ~~**The poutine place does not exist.** The job sends you to the Galeries food
  ...
  was already there — the Galeries' south door has been a hero site since
  commit 4493ab4 (vestibule, orange awning band, canopy, doors, board) — and the job
  ...
  name it (« Le casse-croûte des Galeries — la commande de Sayyad ») instead of
  a food court nobody can walk into. **No business name**: the 120 in `assets/text/storefronts.json`
