...
const daveRace = raceMission({
  ...
  brief: 'Adam a fait quarante minutes depuis Mayo pour dire que son Sunfire est plus vite que ton char. Adam dit ben des affaires.',
  // He does not live here — the Sunfire in the marina lot is where he is.
  giver: 'marina',
  start: 'marina',
  cps: ['mall'],
  money: 25,
  timeOfDay: 'day',
  gridText: 'Le stationnement de la marina',
  ...
  sub: 'W à fond, suis la ligne bleue du GPS jusqu’au pilier — la Principale, le chemin d’Aylmer, pis tout droit',
  win: 'PREMIER.\nAdam arrive douze secondes plus tard, ben tranquille.\n+25 $ — il paye le Slush.',
